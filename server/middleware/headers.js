module.exports = (req, res, next) => {
    ...
    res.header('access-control-allow-methods', 'GET, POST, PUT, DELETE, OPTIONS'); //* spifies the methods allowed when accessing the resource in the responce to a preflight request.
